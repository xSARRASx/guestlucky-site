(function () {
  ...
  ".gl-appbadge{display:inline-flex;align-items:center;gap:10px;padding:9px 16px;border-radius:12px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.16);color:#fff;text-decoration:none;transition:background .2s,border-color .2s,transform .2s}" +
  ".gl-appbadge:hover{background:rgba(255,255,255,.12);border-color:rgba(255,255,255,.32);transform:translateY(-2px)}" +
  ...
  '<a class="gl-appbadge" href="' + URL_APPLE + '" target="_blank" rel="noopener" aria-label="' + (isEN ? 'Download on the App Store' : 'Télécharger sur l\'App Store') + '">' +
  ...
  '<span class="gl-ab-tx"><span class="gl-ab-small">' + dl + '</span><span class="gl-ab-big">App Store</span></span>' +
  '</a>' +
  '<a class="gl-appbadge" href="' + URL_GOOGLE + '" target="_blank" rel="noopener" aria-label="' + (isEN ? 'Get it on Google Play' : 'Disponible sur Google Play') + '">' +
  ...
  '<span class="gl-ab-tx"><span class="gl-ab-small">' + dlG + '</span><span class="gl-ab-big">Google Play</span></span>' +
  '</a>' +
  '</div>';
